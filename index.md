...
Prior to my PhD, I was a [DeepMind Scholar](https://www.cst.cam.ac.uk/deepmind-scholars-cambridge) in MPhil Advanced Computer Science at the [Cambridge Computer Laboratory](https://www.cst.cam.ac.uk/), supervised by [Neil Lawrence](https://inverseprobability.com/). My thesis explored <i>Fairness and the bias–variance trade-off</i> in machine learning models used for automated decision-making. I hold a first-class BSc in Computer Science from the University of Birmingham, where I specialised in AI and completed visiting placements at the Universities of British Columbia and Waterloo.

Earlier in my career, I worked as an AI research consultant in a start-up environment, developing software for autonomous vehicles and designing multi-objective route planning algorithms. This work led to two patents: [Vehicle Route Guidance](https://patents.google.com/patent/US20190346275A1/en) and [Target Speed Optimisation](https://www.search-for-intellectual-property.service.gov.uk/GB2555794).
...
- <b>September 2025:</b> A preprint of my paper <i>Current polygenic risk scores are unlikely to exacerbate unfairness in cardiovascular disease risk prediction </i> is now available [here](https://www.medrxiv.org/content/10.1101/2025.09.18.25336069v1).
- <b>August 2025:</b> Handed in the hardbound copy of my PhD thesis, which is available online [here](https://www.repository.cam.ac.uk/items/410ed92f-0eb0-4e07-8317-6ed774570d0c).
- <b>June 2025:</b> Presented my poster on <i>AI-driven environmental epidemiology: a generalisable framework to predict cardiovascular health using fair and explainable machine learning</i> at the Helmholtz AI conference, available [here](https://zenodo.org/records/17139978). 
